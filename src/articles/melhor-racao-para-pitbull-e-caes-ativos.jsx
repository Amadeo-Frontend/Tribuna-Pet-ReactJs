  ...
  return (
    <>
      <Seo
        ...
        image="https://www.tribunadopet.com.br/images/blog-hero-ranking-desktop.webp"
      ...
      <main className="container max-w-5xl px-4 py-10 mx-auto">
        <article className="overflow-hidden bg-white shadow-xl rounded-2xl">
          ...
          <ScaleIn delay={0.3}>
            <div className="px-6 md:px-8">
              <picture>
                ...
                <img
                  src="/images/blog-hero-ranking-mobile.webp"
          ...
          <div className="p-6 md:p-8">
            ...
            <FadeIn delay={0.8}>
              <div className="my-8">
                <picture>
                  <source media="(min-width: 768px)" srcSet="/images/repotagem-ranking-pitbull-desktop.webp" />
                  <img
                    src="/images/repotagem-ranking-pitbull-mobile.webp"
            ...
            <FadeIn delay={0.9}>
              ...
              <div className="flex justify-center my-6">
                <a
                  href="/images/tabela-ranking-melhores-racoes-de-pitbull.webp"
        ...
        <FadeIn delay={1.6}>
          <AdBanner
            title="Ração Lunch Dog X-PRO Training Super Premium (15kg) - Ração Pets"
            desc="Com Whey Protein, BCAA, Ovo em Pó, Frango e Batata Doce (28% Proteínas). Nutrição de alta performance para cães ativos."
            img="/images/lunch-dog-super-premium-x-pro-training.webp"
            link="https://www.racaopets.com.br/cachorro/racao-seca/super-premium/racao-super-premium-x-pro-training-para-caes-adultos-lunch-dog-sabor-frango-batata-doce-e-linhaca-com-whey-protein-28-proteinas-15-kg"
